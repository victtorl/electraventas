...
<div class="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-4  gap-10">
    ...
    <div  v-for="item in proST.groupProducts" class="rounded overflow-hidden shadow-lg bg-white flex flex-col ">
        ...
        <p class="text-gray-500 text-sm text-center py-2">
               <span class="text-md text-elecktranegro underline cursor-pointer  font-bold " >Ficha tecnica</span>
        </p>

        <div class="px-6 py-3 flex flex-row items-center justify-between  bg-gray-100">
            <button href="#" class="py-1 text-xs w-36 font-regular hover:bg-caribbean-green border-[1.5px] bg-white border-black/30 px-2 rounded-md text-gray-900 mr-1 flex flex-row items-center">
