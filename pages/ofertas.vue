...
<div class="border-b mb-5 flex justify-between text-sm pt-28 ">
    <div class="text-black flex items-center pb-2 pr-2 border-b-2 border-black uppercase">
        ...
        <a href="#" class="font-semibold inline-block">Lista de ofertas</a>
    </div>
    <!-- <a href="#">See All</a> -->
</div>
    ...
    <div  v-for="item in proST.groupOfertas" class="rounded overflow-hidden shadow-lg bg-white flex flex-col ">
        <a
            ...
            <div class="relative"><a href="#">
                <img class="w-full h-44  px-6 pt-6 mt-6 z-100" :src="item.data.imagenes[0]" alt="">
                <!-- <div
            ...
            <div class="px-2 w-full text-center  py-1 flex flex-col items-center justify-center ">
              ...
              <p class="text-gray-500 text-sm text-center">
                <span class="text-md font-bold ">Unid</span> {{ item.data.unidad }}
              </p>
              <p class="text-gray-500 text-sm text-center">
