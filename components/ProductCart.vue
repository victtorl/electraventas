<template>
            ...
            <div class="relative"><a href="#">
              ...
              <a  v-if="props.oferta" >
                <div
                  class="flex items-center text-xs absolute left-0 rounded-r-lg -top-2 right-0 bg-[#f91515]  px-4 py-2 text-white font-semibold mt-3 mr-3 hover:bg-elecktraamarillo hover:text-black transition duration-500 ease-in-out">
                  <div class="w-5 h-5">
            ...
            <div class="px-2 w-full text-center  py-1 flex flex-col items-center justify-center ">
              ...
              <p class="text-gray-500 text-sm text-center">
                <span class="text-md font-bold ">Unid</span> {{ props.medida }}
              </p>
              <p class="text-gray-500 text-sm text-center">
