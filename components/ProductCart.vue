<template>
            ...
            <div class="relative"><a href="#">
                <img class="w-full h-36 sm:h-44     px-6 pt-6 mt-6 z-100" :src="props.imagen?props.imagen:'https://w7.pngwing.com/pngs/765/963/png-transparent-houseplant-silhouette-flowerpot-plant-silhouette-animals-monochrome-computer-wallpaper-thumbnail.png'" alt="">
              ...
              <a  v-if="props.oferta" >
                <div
                  ...
                  <div class="w-5 h-5">
                    <svg fill="#FFFFFF" viewBox="0 -2.5 37 37" version="1.1" xmlns="http://www.w3.org/2000/svg"
                      stroke="#FFFFFF">
            ...
            <div class="px-2 w-full text-center  py-1 flex flex-col items-center justify-center ">
              <NuxtLink :to="`/productos/${props.id}`" @click="llenarDetalleProducto(props.id)"
                class="font-medium text-sm md:text-lg h-10 leading-4 lg:leading-5 py-0 text-center hover:text-black cursor-pointer hover:underline transition duration-500 ease-in-out inline-block module line-clamp">
                {{ props.nombre }}
              </NuxtLink>
              ...
              <p class="text-gray-500 text-sm text-center">
                <span class="text-xs sm:text-sm lg:text-md font-bold text-elecktranegro underline cursor-pointer">Ver Ficha Técnica</span>
              </p>
            </div>
                ...
                <div class="flex items-center justify-between ">
                    ...
                    <div class="w-full h-full grid grid-cols-1 place-items-center content-center ">
                        ...
                        <div class="absolute -top-8 right-0 md:-top-4 md:-right-8 cursor-pointer hover:bg-white hover:rounded-lg "
                            ...
                            <div class="w-8 h-8 " >
                              <svg width="full" height="full" viewBox="0 0 7 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.78033 0.22199C1.48744 -0.0709041 1.01256 -0.0709041 0.71967 0.22199C0.426777 0.514883 0.426777 0.989757 0.71967 1.28265L2.43934 3.00232L0.71967 4.72199C0.426777 5.01488 0.426777 5.48976 0.71967 5.78265C1.01256 6.07554 1.48744 6.07554 1.78033 5.78265L3.5 4.06298L5.21967 5.78265C5.51256 6.07554 5.98744 6.07554 6.28033 5.78265C6.57322 5.48976 6.57322 5.01488 6.28033 4.72199L4.56066 3.00232L6.28033 1.28265C6.57322 0.989757 6.57322 0.514883 6.28033 0.22199C5.98744 -0.0709041 5.51256 -0.0709041 5.21967 0.22199L3.5 1.94166L1.78033 0.22199Z" fill="#0F172A"/>
                                <path d="M1.78033 0.22199C1.48744 -0.0709041 1.01256 -0.0709041 0.71967 0.22199C0.426777 0.514883 0.426777 0.989757 0.71967 1.28265L2.43934 3.00232L0.71967 4.72199C0.426777 5.01488 0.426777 5.48976 0.71967 5.78265C1.01256 6.07554 1.48744 6.07554 1.78033 5.78265L3.5 4.06298L5.21967 5.78265C5.51256 6.07554 5.98744 6.07554 6.28033 5.78265C6.57322 5.48976 6.57322 5.01488 6.28033 4.72199L4.56066 3.00232L6.28033 1.28265C6.57322 0.989757 6.57322 0.514883 6.28033 0.22199C5.98744 -0.0709041 5.51256 -0.0709041 5.21967 0.22199L3.5 1.94166L1.78033 0.22199Z" fill="#0F172A"/>
                              </svg>
                            </div>
                        ...
                        <div class="flex flex-col justify-between items-start   gap-x-10 py-10" id="#interiores">
                            <div class="hidden md:flex flex-row items-center justify-start  w-full px-8 gap-x-4  mt-0" @click="cerrarModal">
                            ...
                            <div class="flex flex-row justify-between items-start    sm:gap-x-10  p-4 lg:p-10 ">
                                <span class="flex flex-row gap-x-1 xs:gap-x-3 h-28 ">
                                    ...
                                    <span class="flex flex-col  justify-between ">
                                        <p class="font-josefS font-bold text-graytitles text-xs xs:w-auto  lg:w-full xs:text-sm md:text-xl ">
                                              {{ props.nombre }}
                                        </p>
                                    </span>
                                </span>
                                <span class="flex flex-col  place-items-end justify-between h-28" >
                                        ...
                                        <span class="flex flex-col md:flex-row justify-center items-end md:gap-x-6  " >
                                            <div class="flex flex-col md:flex-row items-center" >
                                                <span @click="minusQuantityItemModal(props.id)" class="cursor-pointer  p-2 rounded-lg border-2 border-elecktranegro/20" >
                                                  <svg   xmlns="http://www.w3.org/2000/svg" class="w-2.5 fill-current" viewBox="0 0 124 124">
                                                    <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
                                                  </svg>
                                                </span>
                                                ...
                                                <span  @click="addQuantityItemModal(props.id)" class="cursor-pointer  p-2 rounded-lg border-2 border-elecktranegro/20" >
                                                  <svg    xmlns="http://www.w3.org/2000/svg" class="w-2.5 fill-current" viewBox="0 0 42 42">
                                                    <path d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" data-original="#000000"></path>
                                                  </svg>
                                                </span>
                            ...
                            <p class="w-full text-xs px-8 pb-2 text-[#A2A2A2] " >El producto seleccionado pueden agotarse rápidamente. Cotizalos pronto.</p>
                            <div class="flex flex-col lg:flex-row  gap-x-4 px-8 gap-y-4  w-full ">

                                <h2 @click="cerrarModal" class="font-josefS w-full xl:w-96 font-bold text-lg md:text-2xl underline cursor-pointer  bg-white rounded-3xl h-10 text-slate-700  " >Seguir comprando</h2>
