<template>
    <div class="hidden lg:flex justify-center text-white bg-elecktranegro   text-xs lg:text-sm font-manrope " >
      <div class="px-auto px-6 lg:px-16 w-full 3xl:w-maxdesk 3xl:px-0 flex flex-col items-center md:flex-row  justify-between">
        ...
        <ul class="flex gap-x-4 items-center justify-between w-full md:w-auto ">
            <li class="" >
              ...
              aria-label="facebook"
              target="blank"
              class="w-[34px] h-[34px] rounded-full flex justify-center items-center bg-elecktraamarillo border border-white/10 overflow-hidden relative before:inline-block before:absolute before:z-0 before:w-full before:h-full before:bg-white before:scale-x-0 group hover:before:scale-x-100 before:origin-right hover:before:origin-left before:transition-transform before:ease-out before:duration-300"
            >
            ...
            <li class=""  >
              ...
              class="w-[34px] h-[34px] rounded-full flex justify-center items-center border bg-elecktraamarillo border-white/10 overflow-hidden relative before:inline-block before:absolute before:z-0 before:w-full before:h-full before:bg-white before:scale-x-0 group hover:before:scale-x-100 before:origin-right hover:before:origin-left before:transition-transform before:ease-out before:duration-300"
            >
              <span class="relative z-10 ">
                <svg
                  width="16"
